        ...
        <div class="mobile-header-content-area">
          <div class="perfect-scroll">
            ...
            <div class="mobile-menu-wrap mobile-header-border">
              ...
              <nav>
                <ul class="main-menu">
                  <li> <router-link class="dashboard2 active" to="/dashboard"><img src="../assets/imgs/page/dashboard/dashboard.svg" alt="jobBox"><span class="name">Dashboard</span></router-link>
                  </li>
        ...
        <div class="box-heading">
          ...
          <div class="box-breadcrumb"> 
            <div class="breadcrumbs">
              <ul> 
                <li> <router-link class="icon-home" to="/dashboard">Admin</router-link></li>
